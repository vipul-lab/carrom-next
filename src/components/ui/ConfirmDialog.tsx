 ...
 * the consequences, with the real submit inside.
 *
 * The modal is portalled to <body> rather than rendered in place. Every caller
 * sits inside an edit <form>, and a form nested in a form is invalid HTML — the
 * browser drops the inner one, so the confirm button would submit the *outer*
 * form and silently run "save" instead of "delete". Moving it out of the tree
 * is what makes the delete action actually fire.
 */
